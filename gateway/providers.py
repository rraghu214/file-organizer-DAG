...
def build_providers(cache_store):
    ...
    V3 changes vs V2:
    - cerebras worker default: gpt-oss-120b (was qwen-3-235b-a22b-instruct-2507, deprecating May 27 2026)
    ...
    if k := os.getenv("CEREBRAS_API_KEY"):
        out["cerebras"] = CerebrasProvider(k, os.getenv("CEREBRAS_MODEL", "gpt-oss-120b"))
